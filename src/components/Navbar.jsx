...
const Navbar = () => {
  ...
  return (
    ...
    <header id='nav' className="flex py-4 px-4 sm:px-10 font-[sans-serif] min-h-[80px] tracking-wide relative z-50">
      <div className="flex flex-wrap items-center gap-5 w-full">
        <a href="javascript:void(0)">
          <h1 className="w-40 max-lg:mr-5" id='Logo'>Mama's Sweet Treats</h1>
        </a>
